...
const PostVideoLivestream = (props) => {
  return (
    <div className="postVideo">
      <div className="postVideo__user">
        <div
          className="postVideo__user-avatar"
          style={{ backgroundImage: "url(" + props.avatarStreamer + ")" }}
        ></div>
        ...
        <div className="postVideo__user-info">
          <div className="postVideo__user-name">
            ...
            <span>đang phát trực tiếp — đang chơi</span>
            <div className="postVideo__user-game">{props.game}</div>
          </div>
      ...
      <div className="postVideo__video">
        <div className="postVideo__video-info">
          <div className="postVideo__video-title">trực tiếp</div>
          <div className="postVideo__video-view">
            <i className="fa-solid fa-eye"></i>
            <div className="postVideo__video-viewCount">{props.viewCount}</div>
          </div>
        </div>
      ...
      <div className="postVideo__about">
        <div className="postVideo__reaction">
          <div className="postVideo__react">
...
export default PostVideoLivestream;
